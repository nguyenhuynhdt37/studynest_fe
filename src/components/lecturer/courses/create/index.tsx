...
const CreateCourse = () => {
  ...
  const validateStep = (step: number): boolean => {
    ...
    switch (step) {
      case 0: // Basic Info
        ...
        // Topic is optional, so no validation needed
        break;
      case 1: // Description
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await api.post("/lecturer/courses/create", payload);
      const courseId = response.data?.course_id;

      setCreatedCourseId(courseId);
      setSuccessMessage(
        response.data?.message || "✅ Tạo khóa học thành công!"
      );

      // Show upload modal after successful creation
      if (courseId) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Tạo khóa học mới từng bước một cách dễ dàng
          </p>
        </div>
          ...
          {currentStep === 0 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">
                  Bắt đầu với những thông tin cơ bản để học viên có thể tìm thấy
                  khóa học của bạn
                </p>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    💡 Chủ đề giúp phân loại chi tiết hơn cho khóa học của bạn
                  </p>
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">
                  Mô tả chi tiết sẽ giúp học viên hiểu rõ hơn về nội dung và giá
                  trị của khóa học
                </p>
              </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600">
                  Giúp học viên hiểu rõ những gì họ sẽ đạt được sau khi hoàn
                  thành khóa học
                </p>
              </div>
              ...
              <div>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-green-600 bg-green-50 rounded-lg hover:bg-green-100 transition-colors cursor-pointer mt-2"
                >
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">
                  Thiết lập giá cho khóa học và quyết định có xuất bản ngay hay
                  không
                </p>
              </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
              <HiChevronLeft className="h-5 w-5" />
              Quay lại
            </button>
            ...
            {currentStep < totalSteps - 1 ? (
              <button
                type="button"
                onClick={handleNext}
                className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:shadow-lg transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                Tiếp theo
      ...
      {showUploadModal && createdCourseId && (
        <>
          <div
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        const response = await api.post(
                          `/lecturer/courses/upload-thumbnail/${createdCourseId}`,
                          formData,
                          {
                            headers: {
                    ...
                    className="px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:shadow-lg transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {isUploading ? (
                      <>
                        <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
